    ...
    <div className="container mx-auto px-4">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center gap-8 mb-8">
        ...
        <div className="text-center lg:text-left">
          <div className="font-bold text-2xl text-blue-700 mb-3">IIC College</div>
          <div className="text-slate-600 space-y-1">
            <div className="flex items-center justify-center lg:justify-start gap-2">
              ...
              <a href="mailto:iic@college.edu" className="text-blue-600 hover:text-blue-700 hover:underline transition-colors">
                iic@mlritm.ac.in
              </a>
            </div>
            <div className="flex items-center justify-center lg:justify-start gap-2">
              ...
              <span>MLRITM Dundigal, Hyderabad</span>
            </div>
          </div>
        </div>
      ...
      <div className="text-center text-slate-500 text-sm">
        &copy; {new Date().getFullYear()} IIC College. All rights reserved.
      </div>
    </div>
  </footer>
);
